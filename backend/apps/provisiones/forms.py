...
class ProvisionForm(forms.ModelForm):
    class Meta:
        model = Provision
        fields = ['concepto', 'monto_total', 'fecha_pago', 'ahorro_acumulado', 'ahorro_mensual_disponible']
        widgets = {
            ...
            'ahorro_acumulado': forms.NumberInput(attrs={
                'step': '1', 'min': '0',
                'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500',
                'placeholder': 'Ej: 50000',
            }),
            'ahorro_mensual_disponible': forms.NumberInput(attrs={
                'step': '1', 'min': '0',
                'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500',
