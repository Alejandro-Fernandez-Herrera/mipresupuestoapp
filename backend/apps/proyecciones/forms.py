...
class EscenarioForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'factor_ingreso': forms.NumberInput(attrs={
                'step': '0.01', 'min': '0.01', 'max': '2.00',
                'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500',
                'placeholder': 'Ej: 1.10 para +10%',
            }),
            'factor_gasto': forms.NumberInput(attrs={
                'step': '0.01', 'min': '0.01', 'max': '2.00',
                'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500',
...
class ProyeccionIngresoForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'monto_proyectado': forms.NumberInput(attrs={
                'step': '1', 'min': '0',
                'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500',
