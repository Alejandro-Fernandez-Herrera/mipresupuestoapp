...
urlpatterns = [
    ...
    path('ingresos/registrar/', views.registrar_proyeccion_ingreso, name='registrar_ingreso'),
    path('ingresos/<int:pk>/editar/', views.editar_proyeccion_ingreso, name='editar_ingreso'),
    path('ingresos/<int:pk>/eliminar/', views.eliminar_proyeccion_ingreso, name='eliminar_ingreso'),
    ...
    path('gastos/<int:pk>/eliminar/', views.eliminar_proyeccion_gasto, name='eliminar_gasto'),
