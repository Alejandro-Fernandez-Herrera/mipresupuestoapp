...
def ver_proyecciones(request):
    ...
    return render(request, 'proyecciones/ver_proyecciones.html', {
...
def configurar_escenarios(request):
    ...
    return render(request, 'proyecciones/configurar_escenarios.html', {
        'escenarios': escenarios,
        'form': form,
    })
...
def listar_proyecciones_ingreso(request):
    proyecciones = ProyeccionIngreso.objects.filter(usuario=request.user)\
        .select_related('escenario').order_by('-anio', '-mes', 'fuente')
    return render(request, 'proyecciones/listar_ingresos.html', {
...
def registrar_proyeccion_ingreso(request):
    ...
    return render(request, 'proyecciones/form_ingreso.html', {'form': form, 'accion': 'Registrar'})
...
def editar_proyeccion_ingreso(request, pk):
    ...
    return render(request, 'proyecciones/form_ingreso.html', {'form': form, 'accion': 'Editar'})
...
def eliminar_proyeccion_ingreso(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('proyecciones:ingresos')
    return render(request, 'proyecciones/confirmar_eliminar.html', {
        'objeto': p,
...
def listar_proyecciones_gasto(request):
    proyecciones = ProyeccionGasto.objects.filter(usuario=request.user)\
        .select_related('escenario', 'categoria').order_by('-anio', '-mes')
    return render(request, 'proyecciones/listar_gastos.html', {
        'proyecciones': proyecciones,
        'meses_nombre': MESES_NOMBRE,
    })
...
def registrar_proyeccion_gasto(request):
    ...
    return render(request, 'proyecciones/form_gasto.html', {'form': form, 'accion': 'Registrar'})
...
def editar_proyeccion_gasto(request, pk):
    ...
    return render(request, 'proyecciones/form_gasto.html', {'form': form, 'accion': 'Editar'})
