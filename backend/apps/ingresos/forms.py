...
class OtroIngresoForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if tipo == "prima_junio" and mes != "6":
            self.add_error(
                "mes", "La prima de junio solo puede registrarse en el mes de junio."
            )
        if tipo == "prima_diciembre" and mes != "12":
            self.add_error(
                "mes",
                "La prima de diciembre solo puede registrarse en el mes de diciembre.",
            )
