...
urlpatterns = [
    ...
    path('tarjetas/<int:tarjeta_id>/editar/', views.editar_tarjeta, name='editar_tarjeta'),
    path('tarjetas/<int:tarjeta_id>/eliminar/', views.eliminar_tarjeta, name='eliminar_tarjeta'),
    path('tarjetas/<int:tarjeta_id>/toggle/', views.toggle_tarjeta, name='toggle_tarjeta'),
    path('tarjetas/<int:tarjeta_id>/compra/', views.registrar_compra_tc, name='registrar_compra'),
    path('tarjetas/<int:tarjeta_id>/pago/', views.registrar_pago_tc, name='pago_tarjeta'),
]