...
class TarjetaCreditoForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['nombre', 'banco', 'limite', 'tasa_mensual', 'saldo_actual',
                  'fecha_corte', 'fecha_limite_pago', 'cuota_minima_pct']
        widgets = {
            ...
            'tasa_mensual': forms.NumberInput(attrs={
            ...
            'cuota_minima_pct': forms.NumberInput(attrs={
...
class CreditoForm(forms.ModelForm):
    class Meta:
        model = Credito
        fields = ['nombre', 'entidad_tipo', 'capital', 'tasa_ea', 'plazo_meses', 'fecha_desembolso', 'descripcion']
        widgets = {
            'nombre': forms.TextInput(attrs={
                'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500',
                'placeholder': 'Ej: Credito Bancolombia',
            }),
            'entidad_tipo': forms.Select(attrs={
                'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500',
            }),
            ...
            'tasa_ea': forms.NumberInput(attrs={
                'step': '0.000001', 'min': '0', 'max': '1',
                'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500',
            ...
            'fecha_desembolso': forms.DateInput(attrs={
                'type': 'date',
                'class': 'mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500',
            }),
