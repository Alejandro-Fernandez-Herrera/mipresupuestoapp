...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    list_filter = ['ciudad']
    fieldsets = (
        ('Datos personales', {'fields': ('username', 'nombre_completo', 'email', 'ciudad', 'password')}),
        ('Parámetros financieros', {'fields': ('smlv_vigente', 'uvt_vigente', 'auxilio_transporte', 'meta_tasa_ahorro', 'configuracion_fiscal')}),
